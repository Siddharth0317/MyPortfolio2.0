  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-white tracking-tight">Welcome back, Siddharth! 👋</h1>
          <p className="text-xs text-slate-400 mt-1">Authenticated Admin Session ({session?.user?.email || "admin@example.com"}) • System Control Panel</p>
        </div>
